...
const WorkScheduleCreatePage = () => {
  ...
  const { addWorkSchedule, loading, error, setError } = useWorkScheduleContext();
  ...
  const validate = () => {
    ...
    if (form.breakStartTime && form.breakEndTime) {
      if (form.breakEndTime <= form.breakStartTime) {
        newErrors.breakEndTime = "Giờ nghỉ không hợp lệ";
      }
      ...
      <div className="w-full mx-auto">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <div className="bg-gray-200 p-4 border border-[#162F47] rounded-2xl shadow-2xl">
            <div className="border-b border-[#162F47]">
          ...
          {/* TIME */}
          <div className="bg-blue-100 p-4 border border-[#162F47] rounded-2xl shadow-2xl">
            <div className="border-b border-[#162F47]">
          ...
          {/* STATUS */}
          <div className="bg-green-50 p-4 border border-[#162F47] rounded-2xl shadow-2xl">
            <div className="border-b border-[#162F47]">
