...
public class LeaveRequestController {
    ...
    // description = "HR/Manager retrieves all pending leave requests with
    // pagination",
    // responses = {
    // @ApiResponse(responseCode = "200", description = "Pending leave requests
    // retrieved")
    // }
    // )
    // public ResponseEntity<APIResponse<Page<LeaveRequestResponse>>>
    // getPendingRequests(
    // Pageable pageable,
    // HttpServletRequest http) {

    // Page<LeaveRequestResponse> data =
    // leaveRequestService.getPendingRequests(pageable);

    // return ResponseEntity.ok(new APIResponse<>(
    // true,
    // "Pending leave requests retrieved",
    // data,
    // null,
    // http.getRequestURI()));
    // }
    ...
    // ===================== ALL (HR/ADMIN) =====================
    // @GetMapping
    // @Operation(summary = "Get all leave requests", description = "HR/Admin
    // retrieves all leave requests with pagination", responses = {
    // @ApiResponse(responseCode = "200", description = "All leave requests
    // retrieved")
    // })
    // public ResponseEntity<APIResponse<Page<LeaveRequestResponse>>>
    // getAllRequests(
    ...
    // Page<LeaveRequestResponse> data =
    // leaveRequestService.getAllRequests(pageable);
